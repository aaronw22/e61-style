...
For anything other than the most simple functions, use an explicit `return()` for both early returns and returns at the end of the function rather than relying on R to return the last evaluated expression.

```{r eval = FALSE}
# Good
add_two <- function(x, y) {
  x + y
  # The lack of return() is fine because it is very simple
}

complex_function <- function(stuff) {
  # Lots of code
...
add_two <- function(x, y) {
  return(x + y) 
  # return() is probably excessive because it is a very simple function
}
