...
Use underscores (`_`) (this is called snake case) to separate words within a name. 
...
Comments are a vital part of code documentation. They are essential to helping
others (and future you) understand the decisions behind why code was written in
a particular way to do particular things. When writing comments, aim to explain
the *why* rather than *how*. If you are not sure if something needs to be
documented, it is usually better to err on the side of being slightly too
verbose than being too terse when writing comments.
