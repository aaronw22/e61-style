...
Note: this part of the style guide is a style guide for packages, not a guide on how to build an R package, for that, please read [R Packages](https://r-pkgs.org/index.html).
